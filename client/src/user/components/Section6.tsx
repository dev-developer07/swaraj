...
const Section6: FunctionComponent<Section6Type> = ({ className = "" }) => {
  ...
  return (
    <Box
      className={`bg-web-white overflow-hidden flex flex-col items-start !pt-num-200 !pb-num-200 !pl-num-280 !pr-num-280 box-border max-w-full text-left text-num-16 text-web-woodsmoke font-lilex mq1825:!pl-num-140 mq1825:!pr-num-140 mq925:!pt-num-84 mq925:!pb-num-84 mq925:!pl-5 mq925:!pr-5 mq925:box-border mq1350:!pt-num-130 mq1350:!pb-num-130 mq1350:!pl-num-140 mq1350:!pr-num-140 mq1350:box-border mq450:!pt-num-84 mq450:!pb-num-84 mq450:!pl-5 mq450:!pr-5 mq450:box-border ${className} max-[450px]:!w-[390px] max-[450px]:!max-w-full max-[450px]:!mx-auto max-[450px]:!pt-[60px] max-[450px]:!pb-[60px] max-[450px]:!pl-5 max-[450px]:!pr-5`}
    >
