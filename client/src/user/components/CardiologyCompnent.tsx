...
.cs-interventions-card1 { border-right: 2px solid var(--color-gainsboro-100); display: flex; flex-direction: column; align-items: flex-start; padding: 34.9px var(--padding-36) var(--padding-36); gap: 162.7px; grid-column: 1; grid-row: 1; }
...
.cs-interventions-card2 { display: flex; flex-direction: column; align-items: flex-start; padding: 34.9px var(--padding-36) var(--padding-36); gap: 162px; grid-column: 2; grid-row: 1; text-align: left; font-size: var(--fs-36); color: var(--color-gray-300); font-family: var(--font-stack-sans-text); }
...
.cs-svc-card { width: 526px; height: var(--height-250); position: relative; text-align: left; font-size: var(--fs-16); color: var(--color-gray-300); font-family: var(--font-lilex); }
