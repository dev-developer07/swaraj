  ...
  return (
    <>
      ...
      >
        ...
        />
        <Box className="self-stretch flex flex-col items-start z-[1] shrink-0 relative max-[450px]:!w-full max-[450px]:!max-w-full max-[450px]:!gap-6">
          <section className="w-full flex flex-col items-start !pt-5 !pb-num-0 !pl-num-0 !pr-num-0 box-border gap-4 max-w-[800px] text-left text-num-16 text-web-woodsmoke font-lilex mq925:max-w-full max-[450px]:!pt-0 max-[450px]:!gap-6 max-[450px]:!max-w-full max-[450px]:!w-full">
            ...
            <Box className="flex flex-col items-start !pt-num-0 !pb-num-0 !pl-num-0 !pr-5 shrink-0 text-[70px] text-web-white font-stack-sans-text max-[450px]:!pr-0 max-[450px]:!max-w-full max-[450px]:!w-full">
              <Typography
                className="!m-0 relative mq925:text-[56px] mq925:leading-[67px] mq450:text-[42px] mq450:leading-[50px] max-[450px]:!text-[38px] max-[450px]:!leading-[46px] max-[450px]:!tracking-[-0.57px] max-[450px]:!w-full max-[450px]:!h-auto"
                variant="inherit"
          ...
          <section className="self-stretch flex items-end gap-[871px] mq450:gap-[435px] max-[450px]:!gap-0 max-[450px]:!w-full max-[450px]:!max-w-full max-[450px]:!pt-0 max-[450px]:box-border">
            <Box className="flex flex-col items-start !pt-8 !pb-num-0 !pl-num-0 !pr-num-0 shrink-0 max-[450px]:!pt-0 max-[450px]:!w-full max-[450px]:!max-w-full">
              <NavyButton
                label="BOOK AN APPOINTMENT"
                variant="outline"
                endIcon="/container-11.png"
                onClick={() => navigate("/team")}
                className="max-[450px]:!w-[260px] max-[450px]:!h-[44px] max-[450px]:!text-[16px] max-[450px]:!leading-[24px] max-[450px]:[--translate-y:24px]"
              />
            </Box>
