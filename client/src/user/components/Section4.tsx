...
const Section4: FunctionComponent<Section4Type> = ({ className = "" }) => {
  ...
  return (
    ...
    >
          ...
          <section className="w-full grid grid-cols-[repeat(4,_1fr)] gap-4 text-left text-num-16 text-web-woodsmoke font-lilex mq925:flex mq925:flex-col mq925:gap-6 max-[450px]:flex max-[450px]:flex-col max-[450px]:gap-4 mq450:flex mq450:flex-col mq450:gap-6">
            ...
            <Box className="col-[4] flex flex-col items-start max-w-[378px] font-inter mq925:max-w-full mq450:max-w-full justify-end !pb-[10px]">
              <Box className="self-stretch [filter:blur(0px)] flex flex-col items-start">
                <div className="w-[378px] mq925:w-full mq450:w-full max-[450px]:!w-[350px] max-[450px]:!max-w-full max-[450px]:!h-[72px] max-[450px]:!text-[16px] max-[450px]:!leading-[24px] max-[450px]:!flex max-[450px]:!items-center max-[450px]:!text-[#0B0C0F] relative leading-num-24 flex items-center">
      ...
      <Box className="self-stretch bg-web-gray-nurse flex flex-col items-start !pt-num-0 !pb-num-0 !pl-60 !pr-60 mq925:!pl-5 mq925:!pr-5 mq925:box-border mq1350:!pl-num-120 mq1350:!pr-num-120 mq1350:box-border mq450:!pl-5 mq450:!pr-5 mq450:box-border max-[450px]:!bg-[#F1F2F1] max-[450px]:!w-[390px] max-[450px]:!max-w-full max-[450px]:!h-auto max-[450px]:!overflow-y-visible max-[450px]:!px-5 max-[450px]:!mx-auto">
        <Box className="w-full h-[615px] flex flex-col items-start !pt-num-0 !pb-num-0 !pl-num-40 !pr-num-40 mq925:!pl-0 mq925:!pr-0 mq450:!pl-0 mq450:!pr-0 box-border max-w-num-1440 mq925:h-auto mq450:h-auto mq1825:max-w-full max-[450px]:!px-0 max-[450px]:!w-full max-[450px]:!max-w-full max-[450px]:!h-auto max-[450px]:!pl-0 max-[450px]:!pr-0">
          <Box className="w-full overflow-x-auto no-scrollbar">
            <Box className="w-full max-[450px]:!w-max max-[450px]:!min-w-max flex flex-col items-start">
              <section className="w-full max-w-num-1360 h-[77px] mq925:h-auto mq450:h-auto [filter:blur(0px)] border-web-gothic border-solid border-b-[1px] box-border grid grid-cols-[repeat(4,_1fr)] gap-4 text-left text-num-24 mq925:text-num-14 mq450:text-num-14 text-web-woodsmoke font-stack-sans-text max-[450px]:!w-max max-[450px]:!min-w-max max-[450px]:!h-[69px] max-[450px]:!flex max-[450px]:!flex-row max-[450px]:!gap-4">
                <Box className="h-num-76 mq925:h-auto mq450:h-auto flex items-center !pt-num-22 !pb-num-22 mq925:!pt-2 mq925:!pb-2 mq450:!pt-2 mq450:!pb-2 !pl-num-0 !pr-num-0 box-border col-[1_/_span_2] row-[1] max-[450px]:!w-[calc((100vw-56px)/2)] max-[450px]:!min-w-[calc((100vw-56px)/2)] max-[450px]:!h-[68px] max-[450px]:!flex max-[450px]:!justify-center max-[450px]:!items-center max-[450px]:!py-[19px] max-[450px]:!px-0 max-[450px]:!flex-none">
                  <Box className="flex flex-col items-start shrink-0 max-[450px]:!w-[80px] max-[450px]:!h-[30px] max-[450px]:!flex-none">
                    ...
                    >
                      <span className="max-[450px]:hidden">Services</span>
                      <span className="hidden max-[450px]:inline">Features</span>
                    </Typography>
                  </Box>
                </Box>
                <Box className="h-num-76 mq925:h-auto mq450:h-auto bg-web-cloud-burst flex items-center justify-center !pt-num-22 !pb-num-22 mq925:!pt-2 mq925:!pb-2 mq450:!pt-2 mq450:!pb-2 !pl-2 !pr-2 box-border whitespace-nowrap mq925:whitespace-normal text-center col-[3] row-[1] text-web-white max-[450px]:!w-[calc((100vw-56px)/2)] max-[450px]:!min-w-[calc((100vw-56px)/2)] max-[450px]:!h-[62px] max-[450px]:!bg-[#1F2A44] max-[450px]:!flex max-[450px]:!justify-center max-[450px]:!items-center max-[450px]:!py-4 max-[450px]:!px-0 max-[450px]:!flex-none">
                  <Typography
                    className="!m-0 relative shrink-0 mq450:text-num-14 mq450:leading-num-20 max-[450px]:!text-[20px] max-[450px]:!leading-[30px] max-[450px]:!tracking-[-1px] max-[450px]:!w-[61px] max-[450px]:!h-[30px] max-[450px]:!flex max-[450px]:!items-center max-[450px]:!text-[#FFFFFF]"
                    variant="inherit"
                    variantMapping={{ inherit: "h3" }}
                    sx={{
                      fontWeight: "400",
                  ...
                  >
                    <span className="max-[450px]:hidden">Swaraj Hospital</span>
                    <span className="hidden max-[450px]:inline">Swaraj</span>
                  </Typography>
                </Box>
                <Box className="h-num-76 mq925:h-auto mq450:h-auto flex items-center justify-center !pt-num-22 !pb-num-22 mq925:!pt-2 mq925:!pb-2 mq450:!pt-2 mq450:!pb-2 !pl-2 !pr-2 box-border text-center col-[4] row-[1] text-web-gothic max-[450px]:!w-[calc((100vw-56px)/2)] max-[450px]:!min-w-[calc((100vw-56px)/2)] max-[450px]:!h-[68px] max-[450px]:!flex max-[450px]:!justify-center max-[450px]:!items-center max-[450px]:!py-[19px] max-[450px]:!px-0 max-[450px]:!flex-none">
                  ...
                  >
                    <span className="max-[450px]:hidden">Local Hospitals</span>
                    <span className="hidden max-[450px]:inline">Local</span>
                  </Typography>
                </Box>
              </section>
              ...
              <section className="self-stretch flex flex-col items-start max-[450px]:!w-max max-[450px]:!min-w-max">
                <HorizontalBorderBlur
                  sVG="/SVG25.svg"
