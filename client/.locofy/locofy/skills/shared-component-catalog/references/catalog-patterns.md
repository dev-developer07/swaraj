...
This reference is loaded when GATE 1 (Shared Component Catalog) fires in enhance-plan. It shows the five visual primitives that Locofy-generated screens almost always duplicate, with before/after snippets for SwiftUI and Jetpack Compose.
